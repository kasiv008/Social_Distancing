...
def social_distancing_view(frame, distances_mat, boxes, risk_count):
    ...
    for i in range(len(boxes)):
        ...
        img1=cv2.GaussianBlur(img1, (23,23), 30)
        frame[y:y+img1.shape[0], x:x+img1.shape[1]] = img1
    ...
    for i in range(len(distances_mat)):
        ...
        if closeness == 1:
            ...
            img1=frame[y1:y1+h1,x1:x1+w1]
            img1=cv2.GaussianBlur(img1, (23,23), 30)
            frame[y1:y1+img1.shape[0], x1:x1+img1.shape[1]] = img1
